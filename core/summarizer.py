...
japan_relevance は、日本の学校、地域事業者、個人の仕事や暮らしへの影響から、日本での注目度を0-100で付ける。この数値を日次ニュースの並び順に使う。
実測の人気や検索数は与えられていないため「日本で流行している」とは断定せず、日本で役立つ人の多さと影響の近さを評価する。
    ...
    for batch in _chunks(articles, BATCH_SIZE):
        ...
        for i, a in enumerate(batch):
            ...
            result[a.hash] = {
                ...
                "story_example": item.get("story_example", ""),
                "genre": genre,
