...
公式週次ブロックと最新安定版CLIリリースを合わせたSHA-256が前回と同じ場合は、AI APIを呼ばず終了します。新しい期間やCLI安定版が出た時だけ、一般の仕事・教育・地域活動・制作に役立つ機能を最大4件に整理します。複数週止まっていた場合は、未処理の週を古い順に処理します。

## 記事の更新範囲

- `CODEX_UPDATE_CURRENT` 内: 最新のフック、要点、機能、使い方、利用例
