...
SITE_MEDIA_DIR = REPO / "site" / "static" / "media" / "ai-experience-3d-20260810"
...
BEATS = [
    {
        "label": "記事紹介",
        "text": ["ブログ", "AI時代、経験者が再び強くなる理由"],
        "narration": "ブログ。AI時代、経験者が再び強くなる理由。",
        "duration_seconds": 5.0,
        "image": "blog-ai-experience-3d-hero-20260809.png",
        "accent": COLORS["deep"],
    },
    {
        "label": "仮説",
        "text": ["AIは", "仮説を速くつくれる"],
        "narration": "AIは、仮説を速くつくれる。",
        "duration_seconds": 4.3,
        "image": "blog-ai-experience-3d-information-and-reality-20260809.png",
        "accent": COLORS["blue"],
    },
    {
        "label": "現実",
        "text": ["現実で試し、", "確かめるのは人間"],
        "narration": "現実で試し、確かめるのは人間。",
        "duration_seconds": 4.8,
        "image": "blog-ai-experience-3d-reality-check-20260809.png",
        "accent": COLORS["rose"],
    },
    {
        "label": "経験",
        "text": ["経験は、AIの答えを", "使える形へ直す"],
        "narration": "経験は、AIの答えを使える形へ直す。",
        "duration_seconds": 5.2,
        "image": "blog-ai-experience-3d-expert-judgment-20260809.png",
        "accent": COLORS["lilac"],
    },
    {
        "label": "往復",
        "text": ["AIと人間と現実", "この往復が仕事を強くする"],
        "narration": "AIと人間と現実。この往復が仕事を強くする。",
        "duration_seconds": 5.4,
        "image": "blog-ai-experience-3d-loop-20260809.png",
        "accent": COLORS["deep"],
    },
]
...
CAPTION = f"""AIがここまでできるなら、経験はもう要らない？
...
STORY_COPY = "AIが速くつくる仮説を、現実で確かめるのは人。\n経験がAIの答えを使える形へ直します。"
STORY_LINK_LABEL = "詳細はこちら"
BRAND_COMMENT = "AIの答えを、そのまま仕事へ入れる前に一度現場で確かめる。その小さな往復から、一緒に整えていけます。使い方や進め方で迷ったら、気軽にDMしてください。"
...
def make_storyboard(frame_paths: list[Path]) -> Path:
    ...
    title = f"AIと経験の往復｜約{TOTAL_SECONDS:.0f}秒リール（{len(BEATS)}場面）"
...
def make_story_preview() -> Path:
    source = Image.open(SOURCE_DIR / "blog-ai-experience-3d-hero-20260809.png").convert("RGB")
    background = ImageOps.fit(source, (WIDTH, HEIGHT), method=Image.Resampling.LANCZOS)
    ...
    story_lines = ["AIは仮説を", "速くつくれる", "現実で確かめるのは人"]
...
- そのためデザインは、AI相談公式サイトの青 #1F6E8C、ティール #3C9CAD、セージ #6FAF98、白基調を基準にした。
- 既存のAI相談向けリール資産の読みやすい型を継承し、仕事でAIを使う人向けの約{TOTAL_SECONDS:.0f}秒／{len(BEATS)}場面へ更新した。
...
- 難しいAI用語を避け、「AIがここまでできるなら経験は要らない？」という身近な疑問から始めた。
- ロボット、サイバー空間、別事業の配色・写真・ロゴは使っていない。
""",
        encoding="utf-8",
    )
    manifest = {
        "campaign": "2026-08-10-ai-experience-3d-reality",
        "article_title": ARTICLE_TITLE,
        "reel_metadata": review_metadata(),
        "status": REVIEW_STATE,
        "publication_state": PUBLICATION_STATE,
        ...
        "blog": {
            "url": BLOG_URL,
            "source_path": "content/blog/2026-08-09-ai-experience-3d-reality.md",
...
- [ ] 女性ナレーションが{len(BEATS)}場面の中央テキスト全文と合い、音割れや不自然な切れがない
...
def publish_site_assets(video: Path, cover: Path) -> None:
    ...
    shutil.copy2(video, SITE_MEDIA_DIR / "reel.mp4")
    shutil.copy2(cover, SITE_MEDIA_DIR / "cover.png")
