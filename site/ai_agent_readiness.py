...
def render_ai_agent_readiness_page(
    ...
    return "".join(
        [
            ...
            "<meta property='og:title' content='AI Agent Readiness Compass｜AIエージェント実践力診断'>",
            ...
            "<h1 id='readiness-title'><span>AI Agent Readiness Compass</span>AIエージェント実践力診断</h1>",
