...
class SeoLlmoDiagnosisPageTests(unittest.TestCase):
    ...
    def test_builder_writes_the_route_and_sitemap_includes_it(self):
        ...
        try:
            with tempfile.TemporaryDirectory() as tmp:
                ...
                self.assertIn("<loc>https://aiclimb.aiclimb.workers.dev/seo-llmo-diagnosis/</loc>", sitemap)
    ...
    def test_homepage_places_the_fixed_codex_blog_guide_below_site_diagnosis(self):
        ...
        self.assertIn("今日のAIニュースとcodexを読む", section)
        self.assertNotIn("今日のAIニュースと新機能活用術", section)
